...
task meta -Inputs 1.build.ps1, Release-Notes.md -Outputs "Module\$ModuleName.psd1", Src\Directory.Build.props -Jobs version, {
...
task build meta, {
	exec { dotnet build Src\$ModuleName.csproj -c $Configuration -f $TargetFramework --tl:off }
}
