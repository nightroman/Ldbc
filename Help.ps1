...
'@
		GroupBy = @'
Specifies the group by expression.
'@
		OrderBy = @'
Specifies one or more sort expressions, optionally followed by sort orders.
Orders are either [int] or [string] values: 1: ascending, -1: descending.
'@
		Select = @'
